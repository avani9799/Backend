  ...
  <form class="w-50 mt-5" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group mt-3">
            ...
            <div class="form-group mt-3">
                ...
                <!-- <img src="<?php echo "images/".$img ?>" height=50 width=100 /> -->
                <img src="images/<?php echo $img ?>" height=50 width=100 />
                <!-- <img src="" value="<?php echo $img ?>" alt=""> -->
            </div>

            <div class="form-group mt-3">
            <label for="categories">Choose a Categories:</label>
                <select name="categories" id="categories" value="<?php echo $cname ?>">
