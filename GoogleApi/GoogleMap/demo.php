...
<body>
    <div class="jumbotron">
        <div class="container-fluid">
            ...
            <div class="col-xs-offset-2 col-xs-10">
                <button class="btn btn-primary btn-lg" onclick="calcRoute();"><i class="fas fa-map-signs"></i></button>
            </div>
        </div>
        <div class="container-fluid">
            <div id="googleMap">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAdbMcFsUKSIMyWOtXtqA-GWEnJfUc5gH4&libraries=places"></script>
